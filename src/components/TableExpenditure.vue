            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="py-6 px-6 lg:px-8">
                    ...
                    <form class="space-y-6" @submit.prevent="addExpenture">
                        ...
                        <button @click="inputExpendituresAlert" data-modal-toggle="input-expenditures" type="submit" class="w-full text-white bg-yellow-400 hover:bg-amber-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Tambahkan</button>
                    </form>
                </div>
            </div>
        </div>
